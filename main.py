...
parser = argparse.ArgumentParser(description="Enrich TMDB dataset with temporal and credits info.")
parser.add_argument("dataset_path", type=str, help="Path to the input dataset CSV")
parser.add_argument("--output", type=str, default="movies_with_cast_temporal.csv",
                    help="Output CSV filename (default: movies_with_cast_temporal.csv)")
...
oscars_dates = {
    1929: datetime(1929, 5, 16),
    1930: datetime(1930, 4, 3),
    1931: datetime(1930, 11, 5),
    1932: datetime(1931, 11, 10),
    1933: datetime(1932, 11, 18),
    1934: datetime(1933, 3, 16),
    1935: datetime(1934, 2, 27),
    1936: datetime(1935, 3, 5),
    1937: datetime(1936, 3, 4),
    1938: datetime(1938, 3, 10),
    1939: datetime(1939, 2, 23),
    1940: datetime(1940, 2, 29),
    1941: datetime(1941, 2, 27),
    1942: datetime(1942, 2, 26),
    1943: datetime(1943, 3, 4),
    1944: datetime(1944, 3, 2),
    1945: datetime(1945, 3, 15),
    1946: datetime(1946, 3, 7),
    1947: datetime(1947, 3, 13),
    1948: datetime(1948, 3, 20),
    1949: datetime(1949, 3, 24),
    1950: datetime(1950, 3, 23),
    1951: datetime(1951, 3, 29),
    1952: datetime(1952, 3, 20),
    1953: datetime(1953, 3, 19),
    1954: datetime(1954, 3, 25),
    1955: datetime(1955, 3, 30),
    1956: datetime(1956, 3, 21),
    1957: datetime(1957, 3, 27),
    1958: datetime(1958, 3, 26),
    1959: datetime(1959, 4, 6),
    1960: datetime(1960, 4, 4),
    1961: datetime(1961, 4, 17),
    1962: datetime(1962, 4, 9),
    1963: datetime(1963, 4, 8),
    1964: datetime(1964, 4, 13),
    1965: datetime(1965, 4, 5),
    1966: datetime(1966, 4, 18),
    1967: datetime(1967, 4, 10),
    1968: datetime(1968, 4, 10),
    1969: datetime(1969, 4, 7),
    ...
    1980: datetime(1980, 4, 14), 1981: datetime(1981, 3, 31),
